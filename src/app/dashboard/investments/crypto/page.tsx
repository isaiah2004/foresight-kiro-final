          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatInvestmentValue(cryptoData.totalValue, primaryCurrency)}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">
                {formatPercentageChange(cryptoData.totalReturn).formatted}
              </div>
              <p className="text-xs text-muted-foreground">
              ...
              {cryptoInvestments.length === 0 ? (
                <div className="text-center py-4">
                  <p className="text-muted-foreground">
                    No crypto investments to display allocation
                  </p>
                </div>
              ) : (
                cryptoInvestments.map((crypto, index) => {
                  const currentValue =
                    crypto.quantity *
                    (crypto.lastSyncedPrice || crypto.purchasePrice);
                  const allocation =
                    ...
                    >
                      <div className="flex justify-between text-sm">
                        <span className="flex items-center gap-2">
                          ...
                          {crypto.symbol} -{' '}
                          {crypto.metadata?.cryptoName || crypto.symbol}
                        </span>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Start building your cryptocurrency portfolio by adding your
                    first investment.
                  </p>
                  <CryptoInvestmentForm
                    onSubmit={handleAddInvestment}
                ...
                <div className="space-y-4">
                  {cryptoInvestments.map((crypto, index) => {
                    const currentValue =
                      ...
                      (crypto.lastSyncedPrice || crypto.purchasePrice);
                    const investedValue =
                      crypto.quantity * crypto.purchasePrice;
                      ...
                      >
                        <div className="grid gap-4 md:grid-cols-5">
                          ...
                          <div>
                            ...
                            >
                              {
                                formatPercentageChange(returnPercentage)
                                  .formatted
                              }
                            </Badge>
                          </div>
          ...
          <motion.div variants={itemVariants}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Keep your crypto valuations current
                </CardDescription>
              </CardHeader>
              <CardContent>
